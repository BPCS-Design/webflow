...
(function (t, e) {
                            ...
                            if ("title" == i) a.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), o && o.addClass(v + "-corner-right"), (o = null);
                                ...
                                if (
                                    ...
                                    var l = r.theme ? P(r.buttonIcons, i) : null,
                                        c = P(r.buttonText, i),
                                        u = t("<span class='fc-button fc-button-" + i + " " + v + "-state-default'>" + (l ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" + l + "'/>" + "</span>" : c) + "</span>")
                                            .click(function () {
    ...
    function K(n, r, a) {
        ...
        function g() {
            ...
            for (
                a += "<thead><tr>",
                    Xe ? ((t = nn(0, 0)), (e = on(t, Ve)), Ye ? (e += Je) : (e = Je + e), (a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + q(e) + "</th>")) : (a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>"),
                    n = 0;
                We > n;
                n++
            )
        ...
        function o(t, e, n, r) {
            ...
            for (a = 0; h > a; a++)
                (o = t[a]),
                    (i = o.start),
                    (s = e[a]),
                    s > n && r > i && (n > i ? ((l = d(n)), (u = !1)) : ((l = i), (u = !0)), s > r ? ((c = d(r)), (f = !1)) : ((c = s), (f = !0)), v.push({ event: o, start: l, end: c, isStart: u, isEnd: f }));
            return v.sort(ue);
        }
        function i(t) {
        ...
        function s(n, r) {
            ...
            for (k[0].innerHTML = T, m = k.children(), a = 0; S > a; a++)
                (o = n[a]),
                    ...
                    D === !1 ? b.remove() : (D && D !== !0 && (b.remove(), (b = t(D).css({ position: "absolute", top: o.top, left: o.left }).appendTo(k))), (o.element = b), i._id === r ? f(i, b, o) : (b[0]._fci = a), V(i, b));
            ...
            for (a = 0; S > a; a++)
                (o = n[a]),
                    (b = o.element) &&
                        ...
                        (i = o.event),
                        o.contentTop !== e && 10 > M - o.contentTop && (b.find("div.fc-event-time").text(re(i.start, y("timeFormat")) + " - " + i.title), b.find("div.fc-event-title").remove()),
                            ...
                            function (n, a) {
                                if ((K(), n)) {
                                    ...
                                    (i = h(p, u)),
                                        n.row
                                            ? s
                                                ? c && (e.width(f - 10), T(e, v * Math.round((t.end ? (t.end - t.start) / Re : y("defaultEventMinutes")) / g)), e.draggable("option", "grid", [f, 1]), (c = !1))
                                                : (o = !0)
